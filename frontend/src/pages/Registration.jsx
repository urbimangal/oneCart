    ...
    <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-gray-900 to-cyan-950 text-[white] flex flex-col items-center justify-start'>
      ...
      <div className='max-w-[600px] w-[90%] h-[470px] bg-black/40 border-[1px] rounded-lg border-white/50 backdrop-blur-2xl shadow-lg flex items-center justify-center'>
        <form onSubmit={handleSignup} action="" className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]'>
          <div onClick={googleSignup} className='w-[90%] h-[50px] bg-[#2c7264ad] rounded-lg flex items-center justify-center gap-[10px] py-[20px] cursor-pointer'>
            <img className='w-[40px]' src={google} alt="" />Registration with Google
          </div>
          ...
          <div className='relative w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px]'>
            <input type="text" placeholder='Username' required className='w-[100%] h-[50px] border-[2px] border-gray-500 bg-transparent rounded-lg backdrop-blur-sm shadow-lg placeholder-white px-[20px] font-semibold' onChange={(e)=>setName(e.target.value)} value={name}/>
            ...
            <button className='w-[100%] h-[50px] bg-[#5429b0] rounded-lg flex items-center justify-center mt-[20px] text-[17px] font-semibold text-white cursor-pointer'>Create Account</button>
            <p className='flex gap-[10px]'>Already have an Account? <span className='text-[#c988fe] font-semibold text-[17px] cursor-pointer' onClick={()=>navigate("/login")}>Login</span></p>
          </div>
        </form>
      </div>
    </div>
