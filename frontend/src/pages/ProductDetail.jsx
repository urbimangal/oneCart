...
function ProductDetail() {
  ...
  return productData ? (
    <div>
      <div className='w-[100vw] md:w-[99vw] h-[160vh] md:h-[110vh] bg-gradient-to-l from-[#110c14] to-[#122528] flex items-center justify-start flex-col lg:flex-row gap-[20px]'>
        <div className='lg:w-[50vw] md:w-[90vw] lg:h-[90vh] h-[50vh] mt-[70px] flex items-center justify-center md:gap-[10px] gap-[30px] flex-col-reverse lg:flex-row'>
            <div className='lg:w-[20%] md:w-[80%] h-[10%] lg:h-[80%] flex items-center justify-center gap-[50px] lg:gap-[20px] lg:flex-col flex-row'>
                <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px] bg-slate-300 border-[1px] border-zinc-700 rounded-md'>
                    <img src={image1} alt="" className='h-[100%] w-[100%] cursor-pointer rounded-md' onClick={()=>setImage(image1)} />
                </div>
                <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px] bg-slate-300 border-[1px] border-zinc-700 rounded-md'>
                    <img src={image2} alt="" className='h-[100%] w-[100%] cursor-pointer rounded-md' onClick={()=>setImage(image2)} />
                </div>
                <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px] bg-slate-300 border-[1px] border-zinc-700 rounded-md'>
                    <img src={image3} alt="" className='h-[100%] w-[100%] cursor-pointer rounded-md' onClick={()=>setImage(image3)} />
                </div>
                <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px] bg-slate-300 border-[1px] border-zinc-700 rounded-md'>
                    <img src={image4} alt="" className='h-[100%] w-[100%] cursor-pointer rounded-md' onClick={()=>setImage(image4)} />
                </div>
            </div>
            <div className='lg:w-[60%] w-[80%] lg:h-[78%] h-[88%] border-[1px] border-zinc-700 rounded-md overflow-hidden'>
                <img src={image} alt="" className='w-[100%] h-[100%] text-[30px] text-[white] text-center rounded-md object-fill'/>
            </div>
        </div>
        <div className='lg:w-[50vw] w-[100vw] lg:h-[75vh] h-[40vh] lg:mt-[80px] flex items-start justify-start flex-col py-[20px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] lg:py-[0px] gap-[10px]'>
            ...
            <div className='flex items-center gap-1'>
                <FaStar className='text-[20px] fill-[#daec39]'/>
                <FaStar className='text-[20px] fill-[#daec39]'/>
                <FaStar className='text-[20px] fill-[#daec39]'/>
                <FaStar className='text-[20px] fill-[#daec39]'/>
                <FaStarHalfStroke  className='text-[20px] fill-[#daec39]'/>
            ...
            <div className='flex flex-col gap-[10px] my-[10px]'>
                ...
                <div className='flex gap-2'>
                    ...
                    productData.sizes.map((item,index)=>(
                        <button key={index} className={`border py-2 px-4 bg-slate-300 rounded-md cursor-pointer ${item===size?"text-[#2081d6] border-[#2081d6] text-[20px]":""}`} onClick={()=>setSize(item)}>{item}</button>
                    ))
                    }
                </div>
                <button className='text-[16px] active:bg-slate-500 cursor-pointer bg-zinc-600 px-[10px] py-[10px] rounded-2xl mt-[10px] border-[1px] border-zinc-700 text-[white] shadow-md shadow-black' onClick={()=>addToCart(productData._id,size)}>Add to Cart</button>
            </div>
        ...
        <div className='w-[100%] min-h-[70vh] bg-gradient-to-l from-[#110c14] to-[#122528] flex items-start justify-start flex-col overflow-x-hidden'>
            ...
            <div className='w-[80%] md:h-[150px] h-[150px] bg-[#3336397c] border text-white text-[13px] md:text-[15px] lg:text-[20px] px-[10px] md:px-[30px] lg:ml-[100px] ml-[20px]'>
